            ...
            <div class="content">
                <div class="container-fluid">
                    <h4 class="page-title">Category List <h6 class="text-right">
                            ...
                            </div> <a href="{{ route('brand.create') }}"><button class="btn btn-danger"><span
                                        ...
                                        <div class="card-body  text-center">
                                            <div class=" w-100 ">
                                                <div class=" px-2">
                                                    ...
                                                    <label for="caregory" class="mb-4 h1 text-dark">List Brand <span
                                                            class="text-danger">({{ $brands->count() }})</span></label>
                                                        ...
                                                        <tbody>
                                                            @foreach ($brands as $color)
                                                                <tr>
                                                                    ...
                                                                    <td>{{ $color->name }}</td>
                                                                    <td>{{ $color->company }}</td>
                                                                    <td><img src="{{ asset('storage/brands/' . $color->image) }}"
                                                                            height="40px" alt=""></td>
